...
Сервис будет обращаться к пользователю по псевдониму (имени). При пропуске поля с псевдонимом (именем) - по логину (сообщить об этом в примечании к полям).
...
План делит бюджет на блоки и подблоки фиксированной суммы (далее - фиксированные блоки) или блоки с процентом - долей от всего бюджета (далее - процентные блоки).
...
Сохраняется собственный шаблон плана. В течении месяца пользователь может корректировать план.
...
В конце месяца приложение предоставляет пользователю аналитику: насколько хорошо он следовал плану, какие доли бюджета были потрачены на разные категории расходов, остаток, сравнение с предыдущими месяцами и т. п.
...
[Figma](https://www.figma.com/file/RtngiqvSYKLCl5fPUU9P8b/Curly-Life?node-id=0%3A1)

Сервис - SPA, в шапке навигация к трем разделам:
...
Раздел “Профиль” может прибывать в трех состояниях:

- Регистрация:
  Навигация к другим разделам заблокирована
...
- Профиль авторизованного пользователя:
  ...
  Навигация к другим разделам доступна
  ...
  - Выбор суммы на месяц
  - Аналитика за прошлый месяц
...
- Кнопка добавления дохода к бюджету
